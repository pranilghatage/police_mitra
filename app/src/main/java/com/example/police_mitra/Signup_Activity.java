...
public class Signup_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date.setOnClickListener(view -> {
            ...
            DatePickerDialog dt = new DatePickerDialog(Signup_Activity.this, new DatePickerDialog.OnDateSetListener() {
                @Override
        ...
        user = getIntent().getStringExtra("keyname");
        Email.setText(user);
    ...
    private void submission() {
        ...
        UserHelperClass3 helper = new UserHelperClass3(nameval, username, addr, pincodeno, mobileno, aadharno, dateofbirth, gender);
        DatabaseReference ref = fd.getReference("users");
        String nameOnly = username.substring(0, username.indexOf('@'));
        ref.child(nameOnly).child("Profile").setValue(helper);
    ...
    private void createDialog() {
        ...
        builder.setMessage("Details Added successfully. Verify your email and Login with your Credentials.");
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Signup_Activity.this, CitizenloginActivity.class));
            }
        });
        builder.create();
        builder.show();
    ...
    public void uploadImage() {
        ...
        if (selectedImageUri != null) {
            ...
            StorageReference ref = storageReference.child("image/users/" + nameOnly + "/profile/photo");
