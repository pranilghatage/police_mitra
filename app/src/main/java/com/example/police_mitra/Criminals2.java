...
public class Criminals2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_criminals2);
        ...
        criminalsLV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Toast.makeText(Criminals2.this,id+" "+Name,Toast.LENGTH_SHORT).show();
                Intent i=new Intent(Criminals2.this,Criminal_Details.class);
                i.putExtra("Id",id);
